...
int build_hists(int simfrac = 1, int datfrac = 1, float zcut = 30, float simscale = 1.3, float subtracted = 0, float mine = 0, string tag="", int cor = 1)
{
  ...
  float et_em_range[centbins] = {1200,1200,1200,1200,1200,1200,1200,1200,1200};//{150,200,275,350,400,600,800,1200,1750};//{150,150,200,200,275,275,350,350,400,400,600,600,800,800,1200,1200,1750,1750};
