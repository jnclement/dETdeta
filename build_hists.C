...
int build_hists(int simfrac = 1, int datfrac = 1, float zcut = 30, float simscale = 1.3, float subtracted = 0, float mine = 0, string tag="", int cor = 1)
{
  ...
  TFile* simf = TFile::Open(("datatemp/merged_dEdeta"+tag+"_mc_"+(cor?"cor":"unc")+"_501.root").c_str());
  ...
  float et_em_range[centbins] = {0};//{150,150,200,200,275,275,350,350,400,400,600,600,800,800,1200,1200,1750,1750};
