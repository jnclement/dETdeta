...
0.186257,0.211952,0.237171,0.26262,0.28761,0.312813,0.337564,0.362547,0.387076,0.411838,0.43615,0.460697,0.484798,0.509133,0.533027,0.557155,
...
int build_hists(int simfrac = 1, int datfrac = 1, float zcut = 30, float simscale = 1.3, float subtracted = 0, float mine = 0, string tag="", int cor = 1)
{
  ...
  int npart = 0;
  float z_v[2][3];
  TFile* file = TFile::Open("datatemp/merged_dEdeta"+tag+"_data_"+(cor?"cor":"unc")+"_1086.root");
  TTree* tree[2];
